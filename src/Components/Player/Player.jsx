    ...
    return (
        <div className='border-2 border-gray-300 rounded-lg p-6 m-4'>
            ...
            <div className="py-2">
                ...
                <div className="flex lg:justify-between justify-center flex-col md:flex-row lg:flex-row md:justify-between ">
            ...
            <div>
                ...
                <div>
                    <div className="flex items-center justify-between flex-col md:flex-row lg:flex-row  py-2">
